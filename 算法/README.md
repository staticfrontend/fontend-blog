...
* 对根节点的 children 遍历并递归

#### 广度优先遍历算法口诀：

* 广度优先遍历用到了队列：新建一个队列，把根节点入队
...
* 完全二叉树每层节点都完全填满，在最后一层节点上，如果不是满的，则只缺少右边树的节点。

* 完全二叉树所有节点都大于等于(叫做<b>最大堆</b>)或小于等于(叫做<b>最小堆</b>)它的子节点
